...
},{"backbone":"/kx7rk","jquery":"uUqWQm","underscore":"XtpfG/"}],"backbone.marionette":[function(require,module,exports){
module.exports=require('JfD9Vg');
},{}],"/kx7rk":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
...
},{"underscore":"XtpfG/"}],"backbone":[function(require,module,exports){
module.exports=require('/kx7rk');
},{}],"uUqWQm":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
/*!
...
module.exports=require('uUqWQm');
},{}],"XtpfG/":[function(require,module,exports){
var global=typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {};(function browserifyShim(module, exports, define, browserify_shim__define__module__export__) {
//     Underscore.js 1.5.2
...
module.exports=require('XtpfG/');
},{}]},{},["JfD9Vg","/kx7rk","uUqWQm","XtpfG/"])
;
...
},{"./collections/prices":2,"./controller":3,"./models/user":6,"./router":8}],2:[function(require,module,exports){
...
},{"../models/price":5}],3:[function(require,module,exports){
var Marionette = require('backbone.marionette'),
...
},{"./views/appLayout":9,"./views/login":10,"./views/price_details":12,"./views/prices":13,"./views/profile":14,"./views/signup":15,"./views/userDropdown":16}],4:[function(require,module,exports){
var App = require('./app');
var coinwatchapp = new App();
coinwatchapp.start();
...
},{"../plumbing":7}],7:[function(require,module,exports){
module.exports = {
...
},{"../../templates/appLayout.hbs":17,"../plumbing":7,"./navBar":11}],10:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/login.hbs":18}],11:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/navBar.hbs":19}],12:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/price_details.hbs":20}],13:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/price_small.hbs":21}],14:[function(require,module,exports){
var Marionette = require('backbone.marionette');
var plumbing = require('../plumbing');
...
},{"../../templates/profile.hbs":22,"../plumbing":7}],15:[function(require,module,exports){
var Marionette = require('backbone.marionette');
var plumbing = require('../plumbing');
...
},{"../../templates/signup.hbs":23,"../plumbing":7}],16:[function(require,module,exports){
var Marionette = require('backbone.marionette');
...
},{"../../templates/userDropdown.hbs":24}],17:[function(require,module,exports){
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<h3>Login</h3>\n<hr>\n<div class=\"form-group\">\n	<label class=\"sr-only\" for=\"username\">Email/Username</label>\n	<input type=\"email\" class=\"form-control\" id=\"username\" placeholder=\"email/username\">\n</div>\n<div class=\"form-group\">\n	<label class=\"sr-only\" for=\"password\">Password</label>\n	<input type=\"password\" class=\"form-control\" id=\"password\" placeholder=\"Password\">\n</div>\n<div class=\"checkbox\">\n	<label>\n		<input type=\"checkbox\"> Remember me\n	</label>\n</div>\n<button type=\"submit\" class=\"btn btn-primary\">Sign in</button>\n<button class=\"btn btn-default back\">Cancel</button>\n";
  });
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"container-fluid\">\n	<!-- Brand and toggle get grouped for better mobile display -->\n	<div class=\"navbar-header\">\n		<button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\"#bs-navbar-collapse\">\n			<span class=\"sr-only\">Toggle navigation</span>\n			<span class=\"icon-bar\"></span>\n			<span class=\"icon-bar\"></span>\n			<span class=\"icon-bar\"></span>\n		</button>\n		<a class=\"navbar-brand\" href=\"#\">Coinwatch</a>\n	</div>\n\n	<!-- Collect the nav links, forms, and other content for toggling -->\n	<div class=\"collapse navbar-collapse\" id=\"bs-navbar-collapse\">\n		<ul class=\"nav navbar-nav\">\n			<li class=\"active\"><a href=\"#\">Home</a></li>\n			<li><a href=\"#prices\">Buy: $";
  if (stack1 = helpers.buyPrice) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.buyPrice; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
...
},{"hbsfy/runtime":28}],22:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"form-group\">\n	<label for=\"sms\" class=\"col-sm-2 control-label\">\n	SMS Notificaiton Number</label>\n	<div class=\"col-sm-4\">\n		<input type=\"text\" class=\"form-control\" id=\"sms\" value=\"";
  if (stack1 = helpers.sms) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.sms; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n	</div>\n</div>\n\n<div class=\"form-group\">\n	<label for=\"lowerThreshold\" class=\"col-sm-2 control-label\">Lower Threshold</label>\n	<div class=\"col-sm-4\">\n		<input type=\"number\" class=\"form-control\" id=\"lowerThreshold\" value=\"";
  if (stack1 = helpers.lowerThresholdVal) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.lowerThresholdVal; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n	</div>\n	<div class=\"col-sm-6\">\n		<div class=\"checkbox\">\n			<label id=\"lowerNotification\">\n				<input type=\"checkbox\" ";
  if (stack1 = helpers.lowerChecked) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.lowerChecked; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + ">Notification\n			</label>\n		</div>\n	</div>\n</div>\n\n<div class=\"form-group\">\n	<label for=\"upperThreshold\" class=\"col-sm-2 control-label\">Upper Threshold</label>\n	<div class=\"col-sm-4\">\n		<input type=\"number\" class=\"form-control\" id=\"upperThreshold\" value=\"";
  if (stack1 = helpers.upperThresholdVal) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.upperThresholdVal; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "\">\n	</div>\n	<div class=\"col-sm-6\">\n		<div class=\"checkbox\">\n			<label id=\"upperNotification\">\n				<input type=\"checkbox\" ";
  if (stack1 = helpers.upperChecked) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.upperChecked; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + ">Notification\n			</label>\n		</div>\n	</div>\n</div>\n\n<div class=\"form-group\">\n	<div class=\"col-sm-offset-2 col-sm-10\">\n		<button type=\"submit\" class=\"btn btn-primary\">Update Thresholds</button>\n	</div>\n</div>\n";
  return buffer;
  });

},{"hbsfy/runtime":28}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":28}],24:[function(require,module,exports){
// hbsfy compiled Handlebars template
var Handlebars = require('hbsfy/runtime');
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
function program3(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, depth0.isAuthenticated, {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</li>\n";
  return buffer;
  });

},{"hbsfy/runtime":28}],25:[function(require,module,exports){
/*jshint eqnull: true */
...
},{"handlebars/lib/handlebars/base":25,"handlebars/lib/handlebars/runtime":26,"handlebars/lib/handlebars/utils":27}]},{},[4])
;